    ...
    <div>
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center lg:gap-6 gap-2">
          ...
          <button
            onClick={handleSort}
            className="py-1 px-10 rounded-xl font-bold text-black border border-gray-300"
          >
            Sort by Price
          </button>
          <button
      ...
      <div className="mt-10">
        {sortedCart?.map((item, index) => (
          <div
            key={item.id || index}
            className="flex justify-between items-center lg:gap-10 gap-3 p-4 rounded-lg border border-gray-400 mb-2 bg-white"
          >
